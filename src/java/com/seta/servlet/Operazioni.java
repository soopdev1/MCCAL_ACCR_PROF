...
//                }
    ...
    protected void sendconvmail(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        try {
            ...
            if (SendMailJet.sendMail("YES I START UP CALABRIA - Donne e Disoccupati", to, cc, testo, "YES I Start Up Professioni Calabria - Invio convenzione del Soggetto Attuatore " + var[4], new File(ActionB.getPathConvenzioni(username, tipodoc)))) {
        ...
        if (!ActionB.verificaInvioConvenzione(username)) {
            if (ActionB.setStatoInvioDocumenti(username)) {
                try {
                    ...
                    testo = testo.replaceAll("@ragsoc@", var[4]);
                    SendMailJet.sendMail("YES I START UP CALABRIA - Donne e Disoccupati", to, new String[]{}, testo, "YES I Start Up Professioni Calabria - Caricamento documentazione da parte del Soggetto Attuatore " + var[4], null);
                } catch (Exception ex) {
                    Logger.getLogger(Operazioni.class.getName()).log(Level.SEVERE, null, ex);
                    ex.printStackTrace();
                }
    ...
    public void accettaDomanda(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        if (ActionB.setStatoDomandaAccRif(username, accRif, protocollo, "---")) {
            ...
            String to[] = {var[3]};
            try {
                SendMailJet.sendMail("YES I START UP CALABRIA - Donne e Disoccupati", to, new String[]{}, testo, "YES I Start Up - Professioni Calabria - Accettazione domanda accreditamento");
            } catch (MailjetException ex) {
                Logger.getLogger(Operazioni.class.getName()).log(Level.SEVERE, null, ex);
            } catch (MailjetSocketTimeoutException ex) {
                Logger.getLogger(Operazioni.class.getName()).log(Level.SEVERE, null, ex);
